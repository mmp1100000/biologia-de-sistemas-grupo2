...
mkdir -p outputs
mkdir -p data
#wget -nc -q http://www.plosone.org/article/fetchSingleRepresentation.action?uri=info:doi/10.1371/journal.pcbi.1004120.s004 -O data/journal.pcbi.1004120.s004.TSV
# Parse options
